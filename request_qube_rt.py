...
group by entry_date,side,prod_type"""
    ...
    my_sql = "SELECT entry_date,round(amount,1)*1000000 as aum from AUM order by entry_date"
...
def get_start_month_position():
    ...
    my_sql = """SELECT entry_date,amount*1000000 as nav_usd FROM aum WHERE entry_date>='2020-03-01' and entry_date<'2023-05-01';"""
